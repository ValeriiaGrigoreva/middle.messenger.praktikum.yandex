...
export class ChangePasswordPage extends Block<ChangePasswordPageProps> {
    ...
    init() {
        ...
        this.children.oldPasswordInput = new InputBlock({
            ...
            events: {
                'blur': (e: Event) => {
                    console.log(validate('old_password', (<HTMLInputElement>e.target).value))
                }
            }
        })
        ...
        this.children.newPasswordInput = new InputBlock({
            ...
            events: {
                'blur': (e: Event) => {
                    console.log(validate('new_password', (<HTMLInputElement>e.target).value))
                }
            }
        })
        ...
        this.children.newPasswordSecondInput = new InputBlock({
            ...
            events: {
                'blur': (e: Event) => {
                    console.log(validate('repeat_new_password', (<HTMLInputElement>e.target).value))
                }
            }
        })
    }
